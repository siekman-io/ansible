...
<div align="center">
  ...
  <h3 align="center">install-snmp</h3>

  <p align="center">
    Install SNMP on host and set the configuration values community and syslocation and contact
    <br />
...
Install the default packages for snmp, also configure the community , location and contact values. 
There are different OS specific installation tasks for Debian/Ubuntu and RedHat servers.
...
* Set the sysLocation
* Set the sysContact
* The playbook will run install the packages and configure the snmpd.conf
* You're now able to check if the configuration was succesfull with the following command ( make sure you have net-snmp-utils installed)
   ```sh
   snmpwalk -v2c -c (your_community) (Hostname/IP)
   ```
